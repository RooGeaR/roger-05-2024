...
<template>
  <section class='relative h-full w-full max-h-36 max-w-56 pt-3.5 pr-0 pb-2 pl-3 overflow-hidden border border-gray-200 rounded-lg shadow cursor-pointer' @click="handleClick">
